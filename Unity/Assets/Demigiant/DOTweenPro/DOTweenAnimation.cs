    ...
    public class DOTweenAnimation : ABSAnimationComponent
    {
        ...
        public void CreateTween()
        {
            ...
            case DOTweenAnimationType.LocalMove:
                    ...
                    {
                        tween = (transform as RectTransform).DoUILocalMove(endValueV3, duration, optionalBool0);
                    }
                    else
                    {
...
//            return DOTween.TweensByTarget(this.gameObject);
        ...
        void ReEvaluateRelativeTween()
        {
            ...
            {
                if (transform is RectTransform)
                    ((Tweener)tween).ChangeEndValue((transform as RectTransform).anchoredPosition3D + endValueV3, true);
                else
