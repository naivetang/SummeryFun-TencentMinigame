...
{
    [ObjectSystem]
    public class UITeaAwakeSystem : AwakeSystem<UITeaSceneComponent>
    {
        public override void Awake(UITeaSceneComponent self)
        {
            self.Awake();
        }
    }

    public class UITeaSceneComponent : Component
    {
        private GameObject drawscene2;

        private int triggerId = 3010;
        ...
        async ETVoid CollectToBook()
        {
            ...
            com.GetComponent<UIBookComponent>().AddImageGo(this.drawscene2, 10);
        ...
        void Close()
        {
            ...
            Game.Scene.GetComponent<UIComponent>().RemoveUI(UIType.UITeaScene);
        }
