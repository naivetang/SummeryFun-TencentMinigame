...
{
    [ObjectSystem]
    public class UIGooseAwakeSystem : AwakeSystem<UIGooseSceneComponent>
    {
        public override void Awake(UIGooseSceneComponent self)
        {
            self.Awake();
        }
    }

    public class UIGooseSceneComponent : Component
    {
        private GameObject drawscene2;

        private int triggerId = 3006;
        ...
        async ETVoid CollectToBook()
        {
            ...
            com.GetComponent<UIBookComponent>().AddImageGo(this.drawscene2, 6);
        ...
        void Close()
        {
            ...
            Game.Scene.GetComponent<UIComponent>().RemoveUI(UIType.UIGooseScene);
        }
