...
{
    [ObjectSystem]
    public class UIGirlAwakeSystem : AwakeSystem<UIGirlSceneComponent>
    {
        public override void Awake(UIGirlSceneComponent self)
        {
            self.Awake();
        }
    }

    public class UIGirlSceneComponent : Component
    {
        ...
        async ETVoid CollectToBook()
        {
            ...
            com.GetComponent<UIBookComponent>().AddImageGo(this.drawscene2, 4);
        ...
        void Close()
        {
            ...
            Game.Scene.GetComponent<UIComponent>().RemoveUI(UIType.UIGirlScene);
        }
