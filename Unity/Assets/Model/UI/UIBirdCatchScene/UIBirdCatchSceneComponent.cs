...
{
    [ObjectSystem]
    public class UIBirdCatchAwakeSystem : AwakeSystem<UIBirdCatchSceneComponent>
    {
        public override void Awake(UIBirdCatchSceneComponent self)
        {
            self.Awake();
        }
    }

    public class UIBirdCatchSceneComponent : Component
    {
        private GameObject drawscene2;

        private int triggerId = 3007;
        ...
        async ETVoid CollectToBook()
        {
            ...
            com.GetComponent<UIBookComponent>().AddImageGo(this.drawscene2,7);
        ...
        void Close()
        {
            ...
            Game.Scene.GetComponent<UIComponent>().RemoveUI(UIType.UIBirdCatchScene);
        }
