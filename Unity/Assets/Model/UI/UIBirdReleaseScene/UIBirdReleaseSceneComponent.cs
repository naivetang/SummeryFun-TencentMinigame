...
{
    [ObjectSystem]
    public class UIBirdReleaseAwakeSystem : AwakeSystem<UIBirdReleaseSceneComponent>
    {
        public override void Awake(UIBirdReleaseSceneComponent self)
        {
            self.Awake();
        }
    }

    public class UIBirdReleaseSceneComponent : Component
    {
        private GameObject drawscene2;

        private int triggerId = 3008;
        ...
        async ETVoid CollectToBook()
        {
            ...
            com.GetComponent<UIBookComponent>().AddImageGo(this.drawscene2, 8);
        ...
        void Close()
        {
            ...
            Game.Scene.GetComponent<UIComponent>().RemoveUI(UIType.UIBirdReleaseScene);
        }
