...
{
    [ObjectSystem]
    public class UIKiteAwakeSystem : AwakeSystem<UIKiteSceneComponent>
    {
        public override void Awake(UIKiteSceneComponent self)
        {
            self.Awake();
        }
    }

    public class UIKiteSceneComponent : Component
    {
        ...
        async ETVoid CollectToBook()
        {
            ...
            com.GetComponent<UIBookComponent>().AddImageGo(this.drawscene2, 5);
